...
namespace Code.Scripts.EventSystems
{
    ...
    {
        // Set to false in order to disable all debug logs from EventManager and related classes.
        ...
        // EventManager.Instance?.Subscribe(this, (SomeEvent e) => SomeFunctionToCall(e.SomeValue));
